...
Ganglion.prototype._processBytes = function (data) {
  this.emit(k.OBCIEmitterMessage, data);
  ...
  // if(Buffer.isBuffer(this._rawDataPacketToSample)) {
  ...
  //   var raw = [...data]
  //   if(raw[0] == 0) {
  //     console.log('# 18-bit compression with Accelerometer (no aschii raw_parse 1..)')
  //   } else if(raw[0] >= 1 && raw[0] <= 100) {
  //     console.log('# 19-bit compression without Accelerometer (no aschii 18bit parse)')
  //   } else if(raw[0] >=101 && raw[0] <= 200) {
  //     console.log('# Impedance Channel (no aschii 19bit parse)')
  //   } else if(raw[0] >= 201 && raw[0] <= 205) {
  //    console.log('# Part of ASCII -- TODO: better formatting of incoming ASCII (no aschii impedance parse)')
  //   } else if(raw[0] == 206) {
  //     console.log('# End of ASCII message (timer??)(ASCHII) (PRINT RAW ... IT\'S TEXT)')
  //   } else if(raw[0] == 207) {
  //     console.log('print raw, $$$ (not aschii?)')
  //   } else {
  //     console.log("Warning: unknown type of packet: " + raw[0])
  //   }
  // return {};
};
